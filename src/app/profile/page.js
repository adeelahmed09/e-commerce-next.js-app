        ...
        return (
            <div className="w-full flex flex-col gap-5 justify-center items-center  h-screen">
                ...
                <div className="flex items-center justify-center gap-5">
                    <Link href={"/sign-up"} className="text-xl  text-[#e6e6e6] bg-[#0A84FF] font-semibold px-3  py-2 rounded-lg">Sign Up</Link>
                    <Link href={"/login"} className="text-xl text-[#e6e6e6] bg-[#0A84FF] font-semibold px-3 py-2 rounded-lg">Log In</Link>
                </div>
            </div>
        )
    }
